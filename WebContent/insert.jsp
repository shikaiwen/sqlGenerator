...
<%@taglib uri="http://www.kevin.org/mytaglib" prefix="myTag" %>
<% 
...
<myTag:helloWorld name="adf"></myTag:helloWorld>
<%
...
<table width="300px">
<myTag:interator item="book" collection="bookList">
	<tr>
		<td>${pageScope.book}<%="ee" %></td>
	</tr>
</myTag:interator>
</table>
...
<myTag:t1 loop="4">
	<c:if test="1==1">
		<c:out value="1ppppp"></c:out>
	</c:if>
</myTag:t1>

<myTag:nest>
	<myTag:child1>this is child tag</myTag:child1>
</myTag:nest>
</head>
...
function generateSqlWithJs(){
	...
	var sql = "insert into ";
	sql += sqlBlock.find("#tableName").val() +"  (";
