...
$(function(){
	currentNode = parent.window.currentNode;
});
...
function getTableInfo(clickedButton){
	...
	$.ajax({
		...
		url:'centerController/getTableInfo',
...
function realSend(){
	 ...
	 $.post("centerController/handleJson",sendData,function(datas){
			//alert(datas);
			//将文件名传过去
			window.parent.document.getElementById("rightIFrame").src= "centerController/toView?fileName="+datas;
	 });
} 
...
<br>
 <style>
    ...
    <a href="<%=base%>/todownload.7z">download</a>
		...
		<div name="relationBlock" style="float:left;border:1px solid yellow">
			左联<input type="checkbox" id="leftJoin" name="joinType" checked value="1"/>
